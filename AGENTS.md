...
Default database: `/home/feanor/Projects/envoy/.magellan/envoy.db`
...
- Use `magellan watch --root ./src --db .magellan/envoy.db --scan-initial` if the database is missing or stale.
